        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <h3 class="page-title">Carica documenti</h3>
                        </div>
                    ...
                    <%
                        ...
                        if (var == false) {
                            response.sendRedirect("bando_index.jsp?esito=koest");
                        }
                        if (ActionB.verificaPresenzaConvenzioni(Utility.checkAttribute(session,"username"), coddoc)) {
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <form action="Upload?action=simpleConvenzioniSA" method="POST" enctype="multipart/form-data" name="f1">
                                        <input type="hidden" name="tipodoc" value="<%=StringEscapeUtils.escapeHtml4(coddoc)%>" />
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-blue"><i class="fa fa-upload font-blue"></i>Carica documento: <%=titolo%></div>
                                            </div>
                                            <div class="portlet-body">
                                                <div class="row">
                                                    <div class="col-md-12">
