...
public class Label {
    ...
    public static String getMessageReset(String la, String esito) {
        if (la.equals("IT")) {
            return switch (esito) {
                case "passok" -> "Password Modificata!";
                case "passko1" -> "Errore Durante La Modifica Della Password.";
                case "passko2" -> "La Password deve Contenere Almeno un Carattere Numerico!";
                case "passko3" -> "La Password deve Contenere Almeno un Carattere Speciale!";
                case "passko4" -> "La Password Deve Essere Almeno di 8 Caratteri!";
                case "passko5" -> "La Password non Corrispondono!";
                case "passko6" -> "La Nuova Password Deve Essere Diversa Dalla Precedente!";
                case "linguaok" -> "Lingua Cambiata Correttamente.";
                case "linguako" -> "Errore Durante Il Cambiamento Della Lingua.";
                default -> "Errore Durante La Modifica Della Password.";
            };
        } else {
            //ENG
            return switch (esito) {
                case "passok" -> "The Password Has Been Change!";
                case "passko1" -> "Error During Change Password. Try Again.";
                case "passko2" -> "Password Required At Least Numeric!";
                case "passko3" -> "Password Required At Least Special Character!";
                case "passko4" -> "Password Required At Least 8 Character!";
                case "passko5" -> "Password Doesn't Macth!";
                case "passko6" -> "The New Password Must Be Different From The Previous!";
                case "linguaok" -> "Language Has Been Changed.";
                case "linguako" -> "Error During Change Language. Try Again.";
                default -> "Error When Changing Password.";
            };
        }
    }
    ...
    public static String getMessageLogin(String la, String esito) {
        if (la.equals("IT")) {
            return switch (esito) {
                case "KO1" -> "Username e/o Password Errati. Riprovare";
                case "KO2" -> "Username e/o Password Errati. Riprovare";
                case "KO3" -> "Username e/o Password Errati. Riprovare";
                case "KO4" -> "Username e/o Password Errati. Riprovare";
                default -> "Username e/o Password Errati. Riprovare";
            };
        } else {
            //ENG
            return switch (esito) {
                case "KO1" -> "I Dati Formiti Risultano Errati. Riprovare";
                case "KO2" -> "I Dati Formiti Risultano Errati. Riprovare";
                case "KO3" -> "Immettere Tutti i Campi.";
                case "KO4" -> "Immettere Tutti i Campi.";
                default -> esito;
            };
        }
    }
    ...
    public static String getMessageJS(String la, String esito) {
        if (la.equals("IT")) {
            return switch (esito) {
                case "oldpass" -> "Immettere Vecchia Password.";
                case "newpass" -> "Immettere Nuova Password.";
                case "confpass" -> "Immettere Conferma Password.";
                case "user" -> "Immettere Username.";
                case "mail" -> "Immettere e-Mail.";
                case "mailerr" -> "Indirizzo e-Mail ERRATO!";
                case "np1" -> "Nuova Password";
                case "vp1" -> "Vecchia Password";
                case "cp1" -> "Conferma Password";
                case "vita" -> "Italiano";
                case "veng" -> "Passa alla Versione Inglese";
                default -> "";
            };
        } else { //eng
            return switch (esito) {
                case "oldpass" -> "Insert Old Password.";
                case "newpass" -> "Insert New Password.";
                case "confpass" -> "Insert Password Confirm.";
                case "user" -> "Insert Username.";
                case "mail" -> "Insert e-Mail.";
                case "mailerr" -> "Error e-Mail!";
                case "np1" -> "New Password";
                case "vp1" -> "Old Password";
                case "cp1" -> "Confirm Password";
                case "vita" -> "Change to Italian Version";
                case "veng" -> "English";
                default -> "";
            };
        }
    ...
    public static String getMessageRP(String la, String esito) {
        if (la.equals("IT")) {
            return switch (esito) {
                case "ok" -> "La Password &#232; Stata Inviata.";
                case "ko" -> "Username e/o email errati.";
                default -> "";
            };
        } else { //ENG
            return switch (esito) {
                case "ok" -> "The Password Has Been Sent.";
                case "ko" -> "Incorrect Date. Try Again.";
                default -> "";
            };
        }
    }
